 ...
 <div class="container">
  <div class="row">
    ...
    <div id="caixa-2" class="col-sm">
      <h1 align="center" class="display-4">Cilindro</h1>
      <br>
      <div id="formulas">
        ...
        <div id="input" class="container">
          <div  class="input-group mb-3">
            ...
            <input  type="number" min="2.5" max="9" step="0.1" class="form-control" id="altura" aria-describedby="basic-addon3">
          </div>
          <div  class="input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon3">Valor do raio</span>
              </div>
              <input  type="number" min="2.5" max="4.5" step="0.1" class="form-control" id="raio" aria-describedby="basic-addon3">
          </div>
        </div>
