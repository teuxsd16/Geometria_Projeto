...
<html lang="en">
      ...
      <div class="row white">
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center brown-text"><i class="large material-icons">access_time</i></h2>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center brown-text"><i class="large material-icons">aspect_ratio</i></h2>
 ...
 <div class="tap-target" data-target="menu">
   <div class="tap-target-content">
     <h5>Title</h5>
     <p>sdsdsdsdssdsdsd sdsdsd sdsds</p>
   </div>
 </div>
...
$("#but").click(function(){
  ...
  $('.tap-target').tapTarget();
      ...
      <!--script para funcionar o bootstrap-->
