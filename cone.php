 ...
 <div class="container">
  ...
  <div class="row" >
    ...
    <div id="caixa-2" class="col-sm">
      <h1 align="center" class="display-4">Cone</h1>
      <br>
      <div id="formulas">
        ...
        <ul id="lista">
          ...
          <li><span class="fa fa-arrow-right"></span> G<sub>r</sub> = <span id="geratriz"></span> cm</li>
     ...
     <div class="container" id="input">
              ...
              <div  class="input-group mb-3">
                ...
                <input  type="number" min="3" max="7" step="0.1" class="form-control" id="raio" aria-describedby="basic-addon3">
               ...
               <div class="input-group-prepend">
                ...
                <input  type="number" min="5" max="15" step="0.1" class="form-control" id="altura" aria-describedby="basic-addon3">
              </div>
